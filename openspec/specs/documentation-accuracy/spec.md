...
- the `ReadMe.md` of every codeunit (the codeunits of this repository are: SCBuilder, SCGitHubRunner, SCTaskRunnerAndroid, SCTaskRunnerIOS, SCTaskRunnerMacOS, SCTaskRunnerWindows)
- `Contributing.md`
