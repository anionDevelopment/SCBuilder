...
def build():
    ...
    build_arguments={
        ...
        "PlaywrightVersion":dependency_version("Playwright"),
        "GulpCliVersion":dependency_version("GulpCli"),
        "JqVersion":dependency_version("Jq"),
        "YqVersion":dependency_version("Yq"),
        "ShellCheckVersion":dependency_version("ShellCheck"),
        "GitLfsVersion":dependency_version("GitLfs"),
        "GitHubCliVersion":dependency_version("GitHubCli"),
        "GitLabCliVersion":dependency_version("GitLabCli"),
        "KubectlVersion":dependency_version("Kubectl"),
        "HelmVersion":dependency_version("Helm"),
        "KustomizeVersion":dependency_version("Kustomize"),
        "AzureCliVersion":dependency_version("AzureCli"),
        "FlutterVersion":dependency_version("Flutter"),
        "AndroidCmdlineToolsVersion":dependency_version("AndroidCmdlineTools"),
        "AndroidPlatformVersion":dependency_version("AndroidPlatform"),
        "AndroidBuildToolsVersion":dependency_version("AndroidBuildTools"),
        "AndroidNdkVersion":dependency_version("AndroidNdk"),
